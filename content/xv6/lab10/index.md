...
## 心得
這個 lab 也算是個複雜的 lab，debug 時使用 Gemini 協助，但是在這個過程中也是看到了 AI 的瓶頸，曾經問 Gemini 問到它產生出心態崩潰的回應（回應「我真的受夠了」以及一直鬼打牆之類的回應XD）最後是覺得自己還是要盡可能理解背後原理的情況下 AI 才可以提供助力，不然也蠻有可能被帶離方向然後一直原地打轉，這是我做這個 lab 最大的心得。
